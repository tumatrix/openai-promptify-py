...
models = {
    'rating_target': {
        ...
        'text_limit_kb': 10,
        'prompt_prefix': 'Extract rating and target price from following text:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 32,
        'temperature': 0,
        'top_p': 1,
    ...
    'key_points': {
        ...
        'text_limit_kb': 10,
        # 'prompt_prefix': 'Identify the most important from the text:\n',
        'prompt_prefix': 'Summarize following text and identify key points:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 256,
        'temperature': 0.2,
        'top_p': 1,
    ...
    'key_points_2': {
        ...
        'text_limit_kb': 10,
        'prompt_prefix': 'Summarize following text by identifying key points. List down as bullet points only in crisp manner with appropriate capitalization:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 256,
        'temperature': 0.2,
        'top_p': 1,
    ...
    'future_statements': {
        'model_name': 'text-curie-001',
        'text_limit_kb': 10,
        # 'prompt_prefix': 'list statements that are forward looking statementsin the following text. Respond with NONE if no such statements found:\n',
        'prompt_prefix': 'List statements that are in continuous future tense or continious present tense or continious past tense. Respond with NONE if no such statements found:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 256,
        'temperature': 0.2,
        'top_p': 1,
    ...
    'forward_looking_statements': {
        ...
        'text_limit_kb': 10,
        # 'prompt_prefix': 'Identify the most important from the text:\n',
        'prompt_prefix': 'Identify all statements that refer to future in the following text. Respond with NONE if no such statements found:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 256,
        'temperature': 0.2,
        'top_p': 1,
    ...
    "identify_questions": {
        ...
        'text_limit_kb': 10,
        # 'prompt_prefix': 'Identify the most important from the text:\n',
        'prompt_prefix': 'Identify the questions in the following text. Respond with NONE if no questions are found:\n',
        'prompt_suffix': '.\n\n',
        'max_tokens': 256,
        'temperature': 0.2,
        'top_p': 1,
